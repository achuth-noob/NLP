	...
	public static void main(String[] args) throws Exception 
	{
            ...
            while (true) 
	    {
	    	...
	    	for(String s:tt)
	    	{
                ...
                for(int i=0;i<secondList.size()&&isactive==false;i++)
                {
                	String secondString = secondList.get(i);
                	String[] arr = secondString.split("<<>>");
                	String secondStart = arr[0];
                	for(int j=0;j<firstList.size()&&isactive==false;j++)
                	{
                		String firstString = firstList.get(j);
            ...
            if(isactive == true){
                System.out.println("Yes "+printSecondWord+" is active in "+printFirstWord);
            }else{
                System.out.println("No "+printSecondWord+" is not active in "+printFirstWord);
            }
